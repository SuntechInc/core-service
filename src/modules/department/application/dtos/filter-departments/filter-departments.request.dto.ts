...
import { DepartmentFilter } from '../../filters/department-filters';

export class FilterDepartmentsRequestDto {
  ...
  /**
   * Converte o filtro string em objeto DepartmentFilter
   */
  getParsedFilter(): DepartmentFilter | undefined {
